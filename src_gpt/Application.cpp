...
// -----------------------------------------------------------------------------------------------
Application::Application() : Gtk::Application("org.gtkmm.example.main_menu") {
    Glib::set_application_name("MeshViewerApp");
}
...
void Application::on_startup() {
    ...
    // File|New sub menu:
    add_action("newstandard", sigc::mem_fun(*this, &Application::on_menu_file_new_generic));
    add_action("newfoo", sigc::mem_fun(*this, &Application::on_menu_file_new_generic));
    add_action("newgoo", sigc::mem_fun(*this, &Application::on_menu_file_new_generic));
...
// -----------------------------------------------------------------------------------------------
void Application::on_menu_help_about() { std::cout << "Help|About App was selected." << std::endl; }
